...
#
# Created: Sat Aug 23 18:21:35 2014
...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.gridLayout_9 = QtGui.QGridLayout(self.tabServices)
        self.gridLayout_9.setObjectName(_fromUtf8("gridLayout_9"))
        self.gridLayout_8 = QtGui.QGridLayout()
        self.gridLayout_8.setObjectName(_fromUtf8("gridLayout_8"))
        self.label_5 = QtGui.QLabel(self.tabServices)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.gridLayout_8.addWidget(self.label_5, 0, 0, 1, 1)
        self.lineEditWmts = QtGui.QLineEdit(self.tabServices)
        self.lineEditWmts.setObjectName(_fromUtf8("lineEditWmts"))
        self.gridLayout_8.addWidget(self.lineEditWmts, 2, 1, 1, 1)
        self.label_7 = QtGui.QLabel(self.tabServices)
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.gridLayout_8.addWidget(self.label_7, 2, 0, 1, 1)
        self.lineEditSearchServer = QtGui.QLineEdit(self.tabServices)
        self.lineEditSearchServer.setObjectName(_fromUtf8("lineEditSearchServer"))
        self.gridLayout_8.addWidget(self.lineEditSearchServer, 0, 1, 1, 1)
        self.label_6 = QtGui.QLabel(self.tabServices)
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.gridLayout_8.addWidget(self.label_6, 1, 0, 1, 1)
        self.lineEditMapServer = QtGui.QLineEdit(self.tabServices)
        self.lineEditMapServer.setObjectName(_fromUtf8("lineEditMapServer"))
        self.gridLayout_8.addWidget(self.lineEditMapServer, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Settings):
        ...
        self.label_5.setText(_translate("Settings", "Search server", None))
        self.label_7.setText(_translate("Settings", "WMTS capabilities ", None))
        self.label_6.setText(_translate("Settings", "Map server", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabServices), _translate("Settings", "Services", None))
