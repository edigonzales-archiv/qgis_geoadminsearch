...
# translation
SOURCES = geoadminsearch.py ui_geoadminsearch.py __init__.py geoadminsearchdialog.py
#TRANSLATIONS = i18n/sogissuche_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = geoadminsearch

PY_FILES = geoadminsearch.py geoadminsearchdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_settings.py ui_htmlpopup.py
